...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( '关于&ldquo;%2$s&rdquo;共有一条评论', '关于&ldquo;%2$s&rdquo; 共有%1$s条评论', get_comments_number(), 'comments title', 'nisarg' ),number_format_i18n( get_comments_number() ), '<span>' . get_the_title() . '</span>' );
			?>
		</h2>
